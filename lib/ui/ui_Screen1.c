...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Panel1, 1032);
    lv_obj_set_height(ui_Panel1, 818);
    ...
    lv_image_set_src(ui_Image4, &ui_img_lvgl_test_image_png);
    ...
    lv_obj_set_width(ui_Keyboard1, 791);
    lv_obj_set_height(ui_Keyboard1, 251);
    lv_obj_set_x(ui_Keyboard1, -1);
    lv_obj_set_y(ui_Keyboard1, 110);
