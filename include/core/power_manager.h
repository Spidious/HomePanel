...
public:
    ...
    static uint8_t getNormalBrightness() { return normal_brightness; }
    static uint8_t getDimBrightness() { return dim_brightness; }
    ...
    static void setNormalBrightness(uint8_t brightness);
    static void setDimBrightness(uint8_t brightness);
...
private:
    ...
    static uint8_t normal_brightness;         // Normal brightness level (0-255)
    static uint8_t dim_brightness;            // Brightness level when dimmed (0-255)
